...
|-----------|-----------|---------|:------:|
| 高中学校名含省份/城市 | birthplace（籍贯） | 优先匹配"学校名称：XX省XX中学"，提取省份+城市名（如"浙江省杭州中学"→"浙江省杭州市"） | 中，需确认 |
| "赛区XX" | birthplace 辅助验证 | "赛区浙江"→印证浙江籍贯 | 中 |
| 高考成绩单含年份 | birth_date | 从高考年份-18推断出生年份 | 低，仅参考 |
| 竞赛证书含颁发日期 | awards.entries[].date | 补全缺失日期 | 高 |
| 学校含"985/211/双一流"标签 | education.school_type | "XX大学"→"985/双一流" | 高 |
| 培养类别=本科 + 入学年份 | 所在年级 | 2025入学+本科→大二(2026年) | 高 |
| 竞赛全称含"决赛" | awards.entries[].level | "全国中学生数学竞赛决赛"→"国家级" | 高 |
...
**示例**：从奖学金申请扫描件中深度挖掘：
- "浙江省杭州中学" → birthplace="浙江省杭州市"（中可信度）
- "赛区浙江" → 印证 birthplace 推断
- "全国中学生数学竞赛决赛" → awards level="国家级"
- "XX大学" → school_type="985/双一流"
- "本科" + 入学2024 → 所在年级="大二"
...
| 所在单位 | `school` + `department`（如有） | "XX大学计算机科学系" |
...
```
以下字段在您的配置中缺失，请补充：
1. 出生年月：____（建议：从高考准考证推断约2005-2006年）
2. 籍贯：____（建议：浙江省杭州市，推断自"浙江省杭州中学"及"赛区浙江"）
3. 民族：____
