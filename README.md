...
| 文件 | 内容 | 自动填充示例 |
|------|------|------------|
| `personal.yaml` | 姓名、性别、籍贯、政治面貌 | "李奎毅", "男", "云南省安宁市" |
| `contact.yaml` | 手机、邮箱、地址 | "138xxxx1234", "xxx@fudan.edu.cn" |
| `education.yaml` | 学校、院系、专业、学号 | "复旦大学", "高分子科学系" |
| `awards.yaml` | 奖项名称、级别、日期 | "全国物理竞赛决赛 国家级" |
...
示例：
  "云南省安宁中学" → 推断籍贯="云南省安宁市"
  → 用户确认 → 保存到 personal.yaml: birthplace=云南省安宁市
```
...
| 信息源线索 | 推断字段 | 示例 |
|-----------|---------|------|
| 高中校名含省份/城市 | 籍贯 | "云南省安宁中学" → "云南省安宁市" |
| "赛区XX" | 籍贯辅助验证 | "赛区云南" → 印证云南籍贯 |
| 高考年份 | 出生年份 | 2025高考 → 约出生于2007年 |
| 竞赛含"决赛" | 获奖级别 | "全国物理竞赛决赛" → 国家级 |
| 学校名称 | 学校类型 | "复旦大学" → 985/双一流 |
